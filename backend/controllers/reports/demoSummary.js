...
function initialize(req) {
  ...
  var options = {
      url: 'http://localhost:3000/api/trans/report?startDate=2018-02-01&endDate=2018-03-30&amcCode=TMBAM&fundCode=TMBPIPF',
      headers: {
          'User-Agent': 'request'
      }
  };
...
exports.createSummaryReport = (req, res, next) => {
