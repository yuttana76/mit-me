...
const data = { "cusCode":"3560100350330","user":"MPAM001","password":"123456"}
// Build paths
const { buildStreamPathHtml } = require('./buildPaths');
...
exports.creatHTML = (req,res,next)=>{
...
try {
  ...
  res.status(200).json({
    msg:'Succesfully created an HTML table'
  });
} catch (error) {
