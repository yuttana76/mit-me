...
export class SuitFormService {
  ...
  q1 = new Question('1', 'ปัจจุบันท่านอายุ', '','', false,
    [
      new Choice('1', 'มากกว่า 55 ปี', 5),
      new Choice('2', '45 - 55 ปี', 10),
      new Choice('3', '35 - 44 ปี', 15),
      new Choice('4', 'น้อยกว่า 35 ปี', 20),
    ]
    );
  ...
  q4 = new Question('4', 'ท่านเคยมีประสบการณ์ หรือมีความรู้ในการลงทุนในทรัพย์สินกลุ่มใดต่อไปนี้บ้าง (เลือกได้มากกว่า 1 ข้อ)', '','', true, 
    [
      ...
      new Choice('2', 'พันธบัตรรัฐบาล หรือกองทุนรวมพันธบัตรรัฐบาล ', 3),
      new Choice('3', 'หุ้นกู้ หรือกองทุนรวมตราสารหนี้ ', 5),
      new Choice('4', 'หุ้นสามัญ หรือกองทุนรวมหุ้น หรือสินทรัพย์อื่นที่มีความเสี่ยงสูง', 7),
    ]);
