...
export class SuitFormService {
  ...
  label_idCard = 'โปรดระบุ หมายเลขบัตร ';
  ...
  label_input_verify_OTP =  'Enter OTP';
      ...
      new Choice('2', 'ไม่ใช่', 2),
        ...
        , false,true,false,
          ...
          , false,true,false,
            ...
            fatca_q7 = new Question('7', 'ท่านมีคำสั่งทำรายการโอนเงินเป็นประจำโดยอัตโนมัติ จากบัญชีที่เปิดไว้หรือที่มีอยู่กับ บริษัทจัดการ ไปยังบัญชีในสหรัฐอเมริกา ใช่หรือไม่', '',''
              , false,true,false,
                [
                  new Choice('1', 'ใช่', 1),
                  new Choice('2', 'ไม่ใช่', 2),
            ...
            fatca_q8 = new Question('8', 'ท่านมีการมอบอำนาจหรือให้อำนาจในการลงลายมือชื่อแก่บุคคลที่มีที่อยู่ในสหรัฐอเมริกา เพื่อการใด ๆ ที่เกี่ยวข้องกับบัญชีที่เปิดไว้หรือมีอยู่กับ บริษัทจัดการ ใช่หรือไม่', '',''
                , false,true,false,
                  [
                    new Choice('1', 'ใช่', 1),
                    new Choice('2', 'ไม่ใช่', 2),
